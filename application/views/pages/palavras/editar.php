...
<input type="text" name="sublema" size="35" value="<?php echo $palavra['']; ?>">
...
<textarea name="definicao" cols="35" rows="5" value="<?php echo $palavra['']; ?>"></textarea>
<?php echo form_error('definicao'); ?>

<label for="notas_gramatica">Notas Gramaticais</label>
<textarea name="notas_gramatica" cols="35" rows="5" value="<?php echo $palavra['']; ?>"></textarea>
<?php echo form_error('notas_gramatica'); ?>

<label for="notas_cultura">Notas Culturais</label>
<textarea name="notas_cultura" cols="35" rows="5" value="<?php echo $palavra['']; ?>"></textarea>
